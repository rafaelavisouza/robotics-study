...
- [X] Shell scripts for setup automation and log directory creation (`run_experiment.sh`).
- [X] Implementation of basic communication nodes (Publisher/Subscriber) for environment validation.
